			  ...
			  .then(res => {
			    ...
			    http
			      ...
			      .then(res => {
			        ...
			        // console.log("main:" + global.lang);
					console.log(global.select,'global.select')
					document.cookie = 'lang=' + currentLocale;
...
const Jumpstart = (location,cb) => {
	require.ensure([],require => {
		cb(null,require('./containers/jumpstart').default)
	},'Jumpstart')
};
const Thermo = (location,cb) => {
	require.ensure([],require => {
		cb(null,require('./containers/thermo').default)
	},'Thermo')
};
const Yellowbook = (location,cb) => {
	require.ensure([],require => {
		cb(null,require('./containers/yellowbook').default)
	},'Yellowbook')
};
        ...
        return (
          <Router history={this.props.history}>
            <Route path='/' component={App}>
              ...
              <Route path='jumpstart' getComponent={Jumpstart} />
              <Route path='thermo' getComponent={Thermo} />
              <Route path='yellowbook' getComponent={Yellowbook} />
            </Route>
          </Router>
        );
    }
